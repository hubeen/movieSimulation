            ...
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        ...
                        <form class="form-signin" name="signin" method="POST" action="join_act.php">
                            <div class="form-label-group">
                                <input type="text" id="user_name" name="user_name" class="form-control" placeholder="user_name" required autofocus>
                                <label for="user_name">이름</label>
                            </div>

                            <div class="form-label-group">
                                <input type="text" id="user_id" name="user_id" class="form-control" placeholder="user_id" required autofocus>
                            ...
                            <a class="d-block text-center mt-2 small" href="login.php">로그인</a>
                        </form>
                    </div>
                </div>
            </div>
