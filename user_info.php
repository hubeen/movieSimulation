                ...
                <div class="card card-signin my-5">
                    <div class="card-body">
                        ...
                        <div class="form-signin">
                            <button class="btn btn-lg btn-primary btn-block text-uppercase" type="button" onclick="location.href='membership_info.php'">회원 정보</button>
                            <button class="btn btn-lg btn-primary btn-block text-uppercase" type="button" onclick="location.href='reserve_info.php'">예약 정보</button>
                        </div>
                    </div>
                </div>
            </div>
